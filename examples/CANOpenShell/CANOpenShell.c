...
#if	__linux
	libraryPath[0] = "/home/cnhzcy14/work/project/CanFestival-3-90b738e4ede5/lib/libcan_kvaser.so";
	libraryPath[2] = "/home/cnhzcy14/work/project/CanFestival-3-90b738e4ede5/lib/libcan_ixxat.so";
	libraryPath[1] = "/home/cnhzcy14/work/project/CanFestival-3-90b738e4ede5/lib/libcan_copley.so";

#else

//	libraryPath[0] = "libcan_kvaser.so";
	libraryPath[0] = "can_ixxat.dll";
#endif
	...
	for(i=0; i<CAN_NUMBER; i++)
	{
		/* Load can library */
		LoadCanDriver(libraryPath[i]);

		/* Open the CANOpen device */
