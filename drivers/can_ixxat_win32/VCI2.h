...
#define VCI_CANBLUE          17   // CANblue           COM port

#define VCI_TINCAN161        18   // tinCAN 161        pc card
#define VCI_USB2CANII        19   // USB2CAN II        USB port
#define VCI_FLEXRAY          20   // FlexRay           ethernet
#define VCI_IPCIXC_PCI       21   // iPCI XC Karte     PCI slot
#define VCI_CAN_AT_NET_II    22   // CAN@net II        ethernet
...
#define VCI_TWINCAN           0x6
#define VCI_MSCAN             0x7
#define VCI_FLEXCAN           0x8
